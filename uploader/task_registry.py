...
from uploader.forms.crossmatch_resolve_conflicts import (
    ResolveCrossmatchConflictsForm,
    handle_resolve_crossmatch_conflicts,
)
...
def register_all_tasks() -> None:
    ...
    register_task(
        TaskDefinition(
            id="crossmatch-resolve-conflicts",
            title="Resolve crossmatch conflicts",
            description="Push manual crossmatch outcomes to HyperLEDA.",
            form_model=ResolveCrossmatchConflictsForm,
            handler=handle_resolve_crossmatch_conflicts,
            group="Crossmatch",
        ),
    )
